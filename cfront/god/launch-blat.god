God.watch do |w|
	  ...
	  w.log = "/home/ben_coolship_io/crispr/cfront/log/gfserve-hg19.log"
...
God.watch do |w|
	  ...
	  w.log = "/home/ben_coolship_io/crispr/cfront/log/gfserve-mm9.log"
	  w.keepalive(:interval => 15.seconds)
end
...
God.watch do |w|
	  ...
	  w.log = "/home/ben_coolship_io/crispr/cfront/log/gfserve-rn5.log"
	  w.keepalive(:interval => 15.seconds)
end
...
God.watch do |w|
	  ...
	  w.log = "/home/ben_coolship_io/crispr/cfront/log/gfserve-danRer7.log"
	  w.keepalive(:interval => 15.seconds)
end
...
God.watch do |w|
	  ...
	  w.log = "/home/ben_coolship_io/crispr/cfront/log/gfserve-dm3.log"
	  w.keepalive(:interval => 15.seconds)
end
...
God.watch do |w|
	  ...
	  w.log = "/home/ben_coolship_io/crispr/cfront/log/gfserve-susScr3.log"
	  w.keepalive(:interval => 15.seconds)
end
...
God.watch do |w|
	  ...
	  w.log = "/home/ben_coolship_io/crispr/cfront/log/gfserve-galGal4.log"
	  w.keepalive(:interval => 15.seconds)
end
...
God.watch do |w|
	  ...
	  w.log = "/home/ben_coolship_io/crispr/cfront/log/gfserve-tair10.log"
	  w.keepalive(:interval => 15.seconds)
end